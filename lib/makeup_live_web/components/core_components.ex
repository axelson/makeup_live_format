defmodule MakeupLiveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MakeupLiveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MakeupLiveWeb.Gettext, "errors", msg, opts)
    end
  end
